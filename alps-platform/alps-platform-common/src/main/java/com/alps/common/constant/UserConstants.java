package com.alps.common.constant;
...
public class UserConstants
{
    ...
    /** 共用是否唯一的返回结果码 */
    public final static String REQUEST_UNIQUE = "0";
    public final static String UREQUEST__NOT_UNIQUE = "1";
    ...
    /** 箱号识别码是否唯一的返回结果码 */
    public final static String BASEDATA_BOXCODE_UNIQUE = "0";
    public final static String BASEDATA_BOXCODE_NOT_UNIQUE = "1";
    
    /** labelCode是否唯一的返回结果码 */
    public final static String MANAGE_LABELCODE_UNIQUE = "0";
    public final static String MANAGE_LABELCODE_NOT_UNIQUE = "1";
    
    /** 同一业务DB下新增功能不能允许文件覆盖 */
    public final static String MANAGE_LABELPARAM_UNIQUE = "0";
    public final static String MANAGE_LABELPARAM_NOT_UNIQUE = "1";
