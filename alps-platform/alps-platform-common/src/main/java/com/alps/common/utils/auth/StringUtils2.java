...
public class StringUtils2 extends org.apache.commons.lang3.StringUtils{
    ...
    public static boolean checkImgFileType(String fileEnd, String fileType) {
        ...
        if (StringUtils2.isEmpty(fileType)) {
            fileType = StringUtils2.imgType;
        }
    ...
    public static boolean matchYhm(String yhm) {
        ...
        if (!temp) {
            temp = StringUtils2.matchSjhm(yhm);
            if (!temp) {
                temp = StringUtils2.matchYx(yhm);
            }
        }
        return temp;
    }
    ...
    public static boolean matchSjhm(String sjhm) {
        boolean temp = false;
        if (StringUtils2.isNotEmpty(sjhm)) {
