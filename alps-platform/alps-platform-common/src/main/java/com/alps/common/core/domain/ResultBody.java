...
public class ResultBody<T> implements Serializable {
    ...
    @JsonIgnore
    public boolean isOk() {
        return this.code == ErrorCodeEnum.OK.code();
    }


    public static ResultBody ok() {
        return new ResultBody().code(ErrorCodeEnum.OK.code()).msg(ErrorCodeEnum.OK.msg());
    }

    public static ResultBody failed() {
        return new ResultBody().code(ErrorCodeEnum.OK.code()).msg(ErrorCodeEnum.FAIL.msg());
    }
    ...
    public ResultBody msg(String message) {
        this.message = ErrorCodeEnum.getEnum(this.code).msg();
        return this;
    }
