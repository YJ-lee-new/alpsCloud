...
import com.alps.framework.shiro.service.SysPasswordService;
import com.alps.framework.util.ShiroUtils;
import com.alps.provider.system.domain.SysUser;
import com.alps.system.service.ISysPostService;
...
public class SysUserController extends BaseController 
{
    ...
    public AjaxResult importData(MultipartFile file, boolean updateSupport) throws Exception
    {
        ...
        String operName = ShiroUtils.getSysUser().getAccount();
    ...
    public AjaxResult addSave(SysUser user)
    {
        ...
        user.setPassword(passwordService.encryptPassword(user.getAccount(), user.getPassword(), user.getSalt()));
    ...
    {
        return userService.checkLoginNameUnique(user.getAccount());
    }
