...
public class SysRoleController extends BaseController
{
     ...
     * 修改角色
     */
    @GetMapping("/gatewayOuth2/{roleId}")
    public String gatewayOuth2(@PathVariable("roleId") Long roleId, ModelMap mmap)
    {
    	mmap.put("role", roleService.selectRoleById(roleId));
     ...
     */
    @Log(title = "角色管理", businessType = BusinessType.UPDATE)
    @PostMapping("/gatewaysave")
    @ResponseBody
    public AjaxResult gatewaysave(SysRole role)
    {
    	role.setUpdateBy(ShiroUtils.getLoginName());
    	return toAjax(roleService.updateGateway(role));
    } 
