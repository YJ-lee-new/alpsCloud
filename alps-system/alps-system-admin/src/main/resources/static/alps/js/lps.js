    	...
    	modal: {
            ...
            open: function (title, url, width, height, callback) {
            	...
            	layer.open({
            		...
            		shade: 0.3,
            		title: title,
            		content: url.substring(0,url.lastIndexOf("/")+1)+encodeURIComponent(url.substring(url.lastIndexOf("/")+1,url.length)),
            		btn: ['确定', '关闭'],
            	    // 弹层外区域关闭
            		shadeClose: true,
            		yes: callback,
        ...
        operate: {
            ...
            successTabCallback: function(result) {
                if (result.code == web_status.SUCCESS) {
    	            ...
    	            var $contentWindow = $('.alps_iframe[data-id="' + currentId + '"]', topWindow)[0].contentWindow;
    	            $.modal.close();
