...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _slugDefault: function (text) {
        	...
        	//return $h.isEmpty(text) ? '' : String(text);
        },
        ...
        readFiles: function (files) {
            ...
            var self = this, filenameExt=self.notallowedFilenameExtensions, $el = self.$element, reader = self.reader,
            ...
            readFile = function (i) {
                ...
                {
	                var filenamecheck = /[`~!@#$%^&*()_\=<>?:"{}|,\/;'\\[\]·~！@#￥%……&*（）——\={}|《》？：“”【】、；‘’，。、]/im;
                	//var filenamecheck = new RegExp(filenameExt.join('|'), 'img');
    ...
    $.fn.fileinput.defaults = {
        ...
        notallowedFilenameExtensions:null,
