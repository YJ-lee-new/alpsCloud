package com.alps.job.common.executor;

import com.alps.job.common.biz.AdminBiz;
import com.alps.job.common.biz.ExecutorBiz;
import com.alps.job.common.biz.client.AdminBizClient;
import com.alps.job.common.biz.impl.ExecutorBizImpl;
import com.alps.job.common.handler.IJobHandler;
import com.alps.job.common.log.AlpsJobFileAppender;
import com.alps.job.common.thread.ExecutorRegistryThread;
import com.alps.job.common.thread.JobLogFileCleanThread;
import com.alps.job.common.thread.JobThread;
import com.alps.job.common.thread.TriggerCallbackThread;
 ...
 */
public class AlpsJobExecutor  {
    private static final Logger logger = LoggerFactory.getLogger(AlpsJobExecutor.class);
    ...
    public void start() throws Exception {
        ...
        // init logpath
        AlpsJobFileAppender.initLogPath(logPath);
