package com.alps.job.common.util;
 ...
 */
public class AlpsJobRemotingUtil {
    private static Logger logger = LoggerFactory.getLogger(AlpsJobRemotingUtil.class);
    public static String ALPS_RPC_ACCESS_TOKEN = "ALPS_RPC_ACCESS_TOKEN";
    ...
    public static ReturnT<String> postBody(String url, String accessToken, Object requestObj, int timeout) {
        ...
        try {
            ...
            if(accessToken!=null && accessToken.trim().length()>0){
                connection.setRequestProperty(ALPS_RPC_ACCESS_TOKEN, accessToken);
            }
