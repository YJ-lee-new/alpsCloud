...
import com.alps.job.common.util.ScriptUtil;
...
public class ScriptJobHandler extends IJobHandler {
    ...
    public ScriptJobHandler(int jobId, long glueUpdatetime, String gluesource, GlueTypeEnum glueType){
        ...
        File glueSrcPath = new File(AlpsJobFileAppender.getGlueSrcPath());
    ...
    public ReturnT<String> execute(String param) throws Exception {
        ...
        // make script file
        String scriptFileName = AlpsJobFileAppender.getGlueSrcPath()
        ...
        // log file
        String logFileName = AlpsJobFileAppender.contextHolder.get();
        ...
        // invoke
        AlpsJobLogger.log("----------- script file:"+ scriptFileName +" -----------");
