...
package com.alps.job.service.handler;

import com.alps.job.common.log.XxlJobLogger;
...
public class DemoGlueJobHandler extends IJobHandler {
	...
	public ReturnT<String> execute(String param) throws Exception {
		XxlJobLogger.log("ALPS-JOB, Hello World.");
...
#!/usr/bin/env node
console.log("ALPS-JOB: hello nodejs")
...
Write-Host "ALPS-JOB: hello powershell"
