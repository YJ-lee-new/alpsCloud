...
import com.alps.base.api.service.IBaseAppServiceClient;
...
public class AppController implements IBaseAppServiceClient {
    ...
    public ResultBody<IPage<BaseApp>> getAppListPage(@RequestParam(required = false) Map map) {
        IPage<BaseApp> IPage = appService.findListPage(new PageParams(map));
    ...
    public ResultBody<BaseApp> getApp(
        ...
        BaseApp appInfo = appService.getAppInfo(appId);
    ...
    public ResultBody<String> addApp(
        ...
        BaseApp result = appService.addAppInfo(app);
        String appId = null;
        if (result != null) {
    ...
    public ResultBody<String> updateAppClientInfo(
        ...
        BaseApp app = appService.getAppInfo(appId);
        AlpsClientDetails client = new AlpsClientDetails(app.getAppKey(), "", scopes, grantTypes, "", redirectUrls);
