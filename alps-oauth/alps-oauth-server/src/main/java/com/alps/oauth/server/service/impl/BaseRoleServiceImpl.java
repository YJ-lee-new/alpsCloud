...
import com.alps.oauth.server.mapper.BaseRoleMapper;
import com.alps.oauth.server.mapper.BaseRoleUserMapper;
...
public class BaseRoleServiceImpl extends BaseServiceImpl<BaseRoleMapper, BaseRole> implements RoleService {
    @Autowired
