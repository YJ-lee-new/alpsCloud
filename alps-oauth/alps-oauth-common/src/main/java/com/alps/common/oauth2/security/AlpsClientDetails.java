...
public class AlpsClientDetails implements ClientDetails , Serializable {
    ...
    public AlpsClientDetails() {
    }

    public AlpsClientDetails(ClientDetails prototype) {
        this();
    ...
    public AlpsClientDetails(String clientId, String resourceIds,
    ...
    public void setAuthoritiesExt(
            Collection<AlpsAuthority> authorities) {
        this.authorities = new ArrayList<GrantedAuthority>(authorities);
    }
    ...
    public boolean equals(Object obj) {
        ...
        AlpsClientDetails other = (AlpsClientDetails) obj;
