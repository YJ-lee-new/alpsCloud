...
import com.alps.common.oauth2.utils.EncryptUtils;
...
public class RequestMappingScan implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private AlpsScanProperties scanProperties;

    public RequestMappingScan(AmqpTemplate amqpTemplate, AlpsScanProperties scanProperties) {
