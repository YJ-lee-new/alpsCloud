...
@Slf4j
@Component
public class AlpsRestTemplate extends RestTemplate {

    private AlpsCommonProperties common;
    private ApplicationEventPublisher publisher;
    private BusProperties busProperties;
    public AlpsRestTemplate(AlpsCommonProperties common,  BusProperties busProperties, ApplicationEventPublisher publisher) {
        this.common = common;
    ...
    public AlpsCommonProperties getCommon() {
        return common;
    }

    public void setCommon(AlpsCommonProperties common) {
        this.common = common;
    }
}
