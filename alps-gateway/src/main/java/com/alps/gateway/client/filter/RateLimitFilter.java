...
import com.alps.gateway.client.utils.RedisLimiterUtils;
import com.alps.gateway.dynamic.service.DynamicSysClientServiceImpl;
 ...
 * @author:Yujie.lee
 * Date:2019年11月23日
 * Todo  根据应用 url 限流 oauth_client_details if_limit 限流开关
 */
@Slf4j
@Component
public class RateLimitFilter implements GlobalFilter, Ordered {
	...
	@Resource
	DynamicSysClientServiceImpl sysClientServiceImpl;
    ...
    private Boolean checkRateLimit(ServerWebExchange exchange, String accessToken) {
      ...
      // 1. 按accessToken查找对应的clientId
			Map params =   (Map) redisTemplate.opsForValue().get("token:" + accessToken) ;
//		
